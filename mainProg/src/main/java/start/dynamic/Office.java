...
public class Office{
    ...
    public int [] Proc = new int[]{1,2,5,6,7,8,9,10,11};
    // tablica możliwych RAM
    public int [] Ram = new int[]{6,8,9,10};
    ...
    public String Ram(double maxPrice) {
        ...
        while (ok){
            ...
            temp2 += PriceRam(temp);
            Sid += ";";
            if(maxPrice*0.1-temp2<80) ok=false;
        }
        return Sid;
    }
    ...
    public String Mb(String processor, double maxPrice){
        String Sid="";
        int temp;
        temp = ID(maxPrice, MB, danych.MOTHERBOARD, 7, 0.2);
    ...
    public String Hdd(double maxPrice) {
        ...
        while (ok){
            ...
            temp2 += PriceHD(temp);
            Sid += ";";
            if(maxPrice*0.15-temp2<220) ok=false;
        }
        return Sid;
    }
    ...
    public String Ob(double maxPrice) {
        String Sid="";
        int temp;
        temp = ID(maxPrice, CA, danych.CASE, 8, 0.1);
        Sid += temp;
        Sid += ",";
        Sid += PriceC(temp);
        Sid += ";";
